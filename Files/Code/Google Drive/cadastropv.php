  ...
  <body>
    <!-- Primeira divisão da pagina -->
      <!-- Criar a logo da pagina -->
        <div id="primeira"">
        <header id="cabecalho">
          <a id="icone" href="index.php"><img id="icone" src="_imagens/logo3circle.png"></a><!-- Cria um link na logo OBS: tem que trocar o href no futuro -->
        </header>
        </div>
          ...
          <form id="Login" action="cadastrando.php" method="post">
            <table id="ajuste" >
			  ...
			  <tr>
			   ...
			   <td><input type="text" name="tNomeS" id="cNomeS" size="30" maxlength="30" placeholder="Nome visível na rede social"></td>
              </tr>
              ...
              <tr>
				...
				<td><input type="password" name="tSenha" id="cSenha" size="30" minlength="8" maxlength="30" placeholder="Digite a Senha" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,30}" title="Deve conter pelo menos um número e uma letra maiúscula e minúscula e pelo menos 8 ou mais caracteres" required="required"></td>
              </tr>
              ...
              <tr>
                <td><label for="cTele">Telefone:</label></td>
				 <td><input type="tel" name="tTele" id="cTele" size="30" maxlength="11" placeholder="Digite seu Numero"></label></td>
              </tr>
